...
@Component({
  selector: 'app-doha-al-thumama',
  templateUrl: './doha-al-thumama.component.html',
  styleUrls: ['./doha-al-thumama.component.css']
})
export class DohaAlThumamaComponent implements OnInit {
