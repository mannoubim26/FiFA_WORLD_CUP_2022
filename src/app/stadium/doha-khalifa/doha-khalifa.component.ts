...
@Component({
  selector: 'app-doha-khalifa',
  templateUrl: './doha-khalifa.component.html',
  styleUrls: ['./doha-khalifa.component.css']
})
export class DohaKhalifaComponent implements OnInit {
